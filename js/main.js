document.addEventListener("DOMContentLoaded", () => {
  ...
  // 3. GESTION DES FILTRES CATALOGUE 
    ...
    filterButtons.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        filterButtons.forEach(b => {
            b.classList.remove('bg-marron-fonce', 'text-white');
            b.classList.add('bg-white', 'text-marron-fonce');
        });
        btn.classList.remove('bg-white', 'text-marron-fonce');
        btn.classList.add('bg-marron-fonce', 'text-white');
